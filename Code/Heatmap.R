...
list.of.packages <- c("gplots", "ggplot2", "dplyr")
...
library(ggplot2)
library(dplyr)
data <- read.csv("Data/Clean_Metabolmics_Data.csv")
...
tiff("Figures/heatmap_metabolomics.tiff", units="in", width=10, height=6, res=300)
